...
public class CheckHotels extends JFrame implements Runnable{
    ...
    public void run(){
        ...
        String[] text = new String[] { "Pearl Continental Hotel", "Luxus Hunza Hotel", "Ramada Hotel", "Marriott Hotel", "Serena Hotel", "Avari Towers Hotel","Royal Swiss Lahore", "Burj Al Swat Hotel", "Beach Luxury Hotel", "Arcadian Sprucewoods Hotel" };
    ...
    CheckHotels(){
        ...
        for (int i = 0; i <= 9; i++) {
            image[i] = new ImageIcon(ClassLoader.getSystemResource("icons/htl"+(i+1)+".jpg"));
