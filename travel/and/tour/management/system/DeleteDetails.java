...
public class DeleteDetails extends JFrame implements ActionListener {
    ...
    public void actionPerformed(ActionEvent ae){
        try {
            Conn c = new Conn();
            c.s.executeUpdate("delet * from account where username  '"+username+"'");
            c.s.executeUpdate("delet * from customer where username  '"+username+"'");
            c.s.executeUpdate("delet * from bookpackage where username  '"+username+"'");
            c.s.executeUpdate("delet * from bookhotel where username  '"+username+"'");
